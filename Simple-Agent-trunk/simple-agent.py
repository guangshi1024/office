...
log_directory = os.environ.get("LOG_DIRECTORY", "liteagent-logs")
...
def prompt_user():
    ...
    if user_input.lower() == "exit":
        console.print("[blue bold]LiteAgent:[/blue bold] Goodbye!")
...
def on_new_agent_message(message: str):
    console.print("[blue bold]LiteAgent:[/blue bold]")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run the LiteAgent chatbot.")
    ...
    console.print("[blue bold]LiteAgent:[/blue bold] Hello and welcome! My name is LiteAgent!")
